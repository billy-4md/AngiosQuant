...
def _plugin_wrapper():
    ...
    #Added by Xavier Dekeme - Option to export the mask produced
    def export(
    sliders_widget,
    ...
    export_stack: bool = False,
        ...
        if n_dims == 2:
            ...
            if n_dims == 3:
                ...
                raise ValueError(f"Unsupported data dimensionality: {n_dims}D")
        ...
        slice_results = np.concatenate(slice_results, axis=0) if slice_results else np.empty((0, 5))

        file_path = folder / filename  # Construct the full file path
        ...
        if output_type == "csv":
            ...
            # Additional logic needed for creating masks from circle coordinates
            raise NotImplementedError("Mask output not yet implemented.")
